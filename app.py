...
class App:
    ...
    def init_gui(self):
        ...
        self.classname_3 = simpledialog.askstring("Classname Three", "Enter the name of the third class:", parent=self.window)
        self.classname_4 = simpledialog.askstring("Classname Four", "Enter the name of the Fourth class:", parent=self.window)
        ...
        self.btn_class_3 = tk.Button(self.window, text=self.classname_3, width=50, command=lambda: self.save_for_class(3))
        self.btn_class_3.pack(anchor=tk.CENTER, expand=True)
        
        self.btn_class_4 = tk.Button(self.window, text=self.classname_4, width=50, command=lambda: self.save_for_class(4))
        self.btn_class_4.pack(anchor=tk.CENTER, expand=True)
    ...
    def predict(self):
        ...
        if prediction == 3:
            self.class_label.config(text=self.classname_3)
            return self.classname_3
        if prediction == 4:
            self.class_label.config(text=self.classname_4)
            return self.classname_4